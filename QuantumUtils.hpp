...
void spinOrbitalFock(Eigen::MatrixXd *FSO, Eigen::MatrixXd *TEI_MOspin, Eigen::MatrixXd *h);
...
void molecularToMolecularSpin(Eigen::MatrixXd *TEI_MOspin, Eigen::MatrixXd *TEI_MO, int n);
